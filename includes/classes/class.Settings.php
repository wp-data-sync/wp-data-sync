...
class Settings {
    ...
    public function set_active_tab() {
        ...
        if ( isset( $_GET['active_tab'] ) ) {
            $this->active_tab = sanitize_text_field( wp_unslash( $_GET['active_tab'] ) );
        }
    ...
    public function settings_page() {
        ...
        if ( ! current_user_can( WPDSYNC_CAP ) ) {
            wp_die( esc_html__( 'You do not have sufficient permissions to access this page.', 'wp-data-sync' ) );
        }
    ...
    public function report_values() {
        ...
        $report_values = [
            [
                'label' => __( 'Home URL', 'wp-data-sync' ),
                'value' => home_url()
            ],
            [
                'label' => __( 'Site URL', 'wp-data-sync' ),
                'value' => site_url()
            ],
            [
                'label' => __( 'REST API URL', 'wp-data-sync' ),
                'value' => get_rest_url()
            ],
            [
                'label' => __( 'WP Data Sync Version', 'wp-data-sync' ),
                'value' => defined( 'WPDSYNC_VERSION' ) ? WPDSYNC_VERSION : 'NA'
            ],
            [
                'label' => __( 'WordPress Version', 'wp-data-sync' ),
                'value' => $wp_version
            ],
            [
                'label' => __( 'WooCommerce Version', 'wp-data-sync' ),
                'value' => defined( 'WC_VERSION' ) ? WC_VERSION : 'NA'
            ],
            [
                'label' => __( 'PHP Version', 'wp-data-sync' ),
                'value' => phpversion()
            ],
            [
                'label' => __( 'Database Table Prefix', 'wp-data-sync' ),
                'value' => $wpdb->prefix
            ],
            [
                'label' => __( 'WordPress Multisite', 'wp-data-sync' ),
                'value' => is_multisite() ? 'Yes' : 'No'
            ],
            [
                'label' => __( 'WP PHP Memory Limit', 'wp-data-sync' ),
                'value' => defined( 'WP_MEMORY_LIMIT' ) ? WP_MEMORY_LIMIT : 'NA'
            ],
            [
                'label' => __( 'PHP Memory Limit', 'wp-data-sync' ),
                'value' => ini_get( 'memory_limit' )
            ],
            [
                'label' => __( 'Post Max Size', 'wp-data-sync' ),
                'value' => ini_get( 'post_max_size' )
            ],
            [
                'label' => __( 'Max Execution Time', 'wp-data-sync' ),
                'value' => ini_get( 'max_execution_time' )
            ],
            [
                'label' => __( 'Max Upload Size', 'wp-data-sync' ),
                'value' => ini_get( 'max_upload_size' )
            ],
            [
                'label' => __( 'Upload Max Filesize', 'wp-data-sync' ),
                'value' => ini_get( 'upload_max_filesize' )
            ],
            [
                'label' => __( 'Max Input Time', 'wp-data-sync' ),
        ...
        foreach ( $plugins as $plugin ) {
            ...
            $report_values[] = [
                'label' => __( 'Plugin (active)', 'wp-data-sync' ),
                'value' => $plugin
            ];
