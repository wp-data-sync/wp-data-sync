...
abstract class Request {
    ...
    public function request_data() {
        ...
        add_filter( 'wp_kses_allowed_html', [ $this, 'allowed_html' ], PHP_INT_MAX, 2 );
    ...
    public function allowed_html( array $tags, string $content ): array {

        if ( Settings::is_checked( 'wp_data_sync_allow_iframes' ) ) {
            $tags['iframe'] = [
                'src'                 => true,
                'height'              => true,
                'width'               => true,
        ...
        return apply_filters( 'wp_data_sync_allowed_html', $tags, $content );
